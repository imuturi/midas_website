            ...
            >
              <div className="single-footer-widget">
                ...
                <div className="footer-content">
                  <p>
                    Midas ERP is an all-in-one business management solution
                    designed to streamline operations, enhance productivity, and
                    drive growth for companies across industries.
                  </p>
              ...
              <div className="single-footer-widget">
                <div className="contact-box">
                  ...
                  <div className="info">
                    ...
                    <div className="link">
                      <a href="mailto:support@midaserp.com">
                        support@midaserp.com
                      </a>
                      <br />
                      <a href="mailto:info@midaserp.com">info@midaserp.com</a>
                    </div>
                  </div>
                  <div className="info">
                    <div className="icon">
                    ...
                    <div className="link">
                      ...
                      <br />
                      <a href="tel:+254798765432">+254 798 765 432</a>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="container">
          <div className="footer-wrapper d-flex align-items-center justify-content-between">
            <p className="wow fadeInLeft" data-wow-delay=".3s">
              © {new Date().getFullYear()} Midas ERP. All rights reserved.
            </p>
